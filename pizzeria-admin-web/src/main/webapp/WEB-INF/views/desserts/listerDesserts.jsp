...
<div class="jumbotron">
	<div class="container">
		...
		<a class="btn btn-primary" href="new">Nouveau Dessert</a> <br>
		<c:if test="${msg != null}">
			...
			<c:forEach var="dessert" items="${listeDesserts}">
				<tr>
					...
					<td>
						<div class="row">
							<div class="col-md-6">
								Ref. ${dessert.id} <br> <b>${dessert.nom}</b><br>${dessert.prix}
								€<br>
							</div>
							<div class="col-md-6">
								<a href="<c:url value="/desserts/edit?code=${dessert.code}"/>"
