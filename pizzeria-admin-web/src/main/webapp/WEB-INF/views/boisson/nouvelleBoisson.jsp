				...
				<div class="container">
					...
					<form method="post">
						<label for="newcode">Code :</label> <input
							style="border-color:${erreur[0]}" class="form-control"
							name="code" type="text" placeholder="Code" value="${code}">

						<label for="ref">Nom :</label> <input
							style="border-color:${erreur[1]}" class="form-control" name="nom"
							type="text" placeholder="Nom" value="${nom}"> <label
							for="prix">Prix : </label> <input
							style="border-color:${erreur[2]}" step="0.01"
							class="form-control" name="prix" type="number" placeholder="prix"
							value="${prix}">
