			...
			<div class="jumbotron">
				<div class="container">		
					...
					<form method="post">				
						...
						<div class="form-group">
							<label>Prix : </label> 
							<input step="0.01" id="number" name="prix" class="form-control" type="number" value="${boisson.prix}" required>
						</div>				
						<div class="form-group">
							<label for="image"> Image :</label> 
							<input id="urlImage" name="urlImage" class="form-control" type="text" placeholder="Lien vers image" value="${boisson.urlImage}" required>
						</div>				
