...
public class JeuxDonnees {
	...
	private void generatePizzas(){
		...
		pizzas.add(new Pizza("4FRO", "4 Fromages", BigDecimal.valueOf(14.70), CategoriePizza.SANS_VIANDE,
				"http://www.cicis.com/media/1177/pizza_trad_cheese_sm.png", LocalDateTime.now(), true, TypePizza.PIZZA,  ingredients));
		...
		pizzas.add(new Pizza("SAUC", "Saucisses", BigDecimal.valueOf(10.50), CategoriePizza.VIANDE,
				"http://www.cicis.com/media/1169/pizza_trad_sausage_sm.png", LocalDateTime.now(), true, TypePizza.PIZZA,  ingredients));
		pizzas.add(new Pizza("SAUM", "Saumon", BigDecimal.valueOf(10.50), CategoriePizza.POISSON,
				"https://www.dominos.fr/ManagedAssets/FR/product/PSSE/FR_PSSE_fr_hero_1146.png?v1112248177", LocalDateTime.now(), true, TypePizza.PIZZA,  ingredients));
		...
		pizzas.add(new Pizza("POUL", "Poulet", BigDecimal.valueOf(13.20), CategoriePizza.VIANDE,
				"http://www.cicis.com/media/1336/buffalo-chicken_new72dpi.png", LocalDateTime.now(), true, TypePizza.PIZZA,  ingredients));
		...
		pizzas.add(new Pizza("REI", "Reine", BigDecimal.valueOf(16.80), CategoriePizza.VIANDE,
				"https://www.dominos.fr/ManagedAssets/FR/product/PREI/FR_PREI_fr_hero_541.png?v-1935795394", LocalDateTime.now(), true, TypePizza.PIZZA,  ingredients));
